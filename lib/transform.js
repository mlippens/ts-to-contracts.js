    ...
    var ModuleContract = (function () {
        ...
        ModuleContract.prototype.toContract = function() {
            ...
            for (i = 0; i < this.classes.length; i ++) {
                ...
                result = result + tmpl("declaration", {name: this.classes[i].name, value: this.classes[i].toContract()});
            }
...
var ast = (function(ast) {
    ...
    ast.isModuleClass = function(node) {
        return isModuleMember(node) && node.typeDeclaration.type === "ClassDeclaration";
    };

    ast.isModuleInterface = function(node) {
        return isModuleMemebr(node) && node.typeDeclaration.type === "InterfaceDeclaration";
    };
