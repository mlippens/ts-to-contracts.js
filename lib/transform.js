...
utils = (function (utils) {
    ...
    var ModuleContract = (function () {
        ...
        ModuleContract.prototype.toContract = function() {
            ...
            for (i = 0; i < this.classes.length; i ++) {
                ...
                //we dont really care whether the name changed...
    ...
    /***
     * todo: either fix ast so all ObjectTypeDeclarations are conform or differentiate here
     * todo: find out why node.type should be interfacedeclaration there or why it is there?
     *
     * @param node
     * @returns {ObjectContract}
     */
    ...
    var registerVariable = function (name) {
        ...
        if (contains) {
            return registerVariable("_".concat(name));
        } else {
    ...
    var hashUtils = (function(hashUtils) {
        hashUtils.put = function(obj) {
            return function (key, value) {
              var prop;
              for (prop in obj) {
                  if ({}.prototype.hasOwnProperty.call(obj, prop)) {
