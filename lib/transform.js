...
utils = (function (utils) {
    ...
    var ClassContract = (function () {
        var ClassContract = function(name, instanceMembers, staticMembers, constructor) {
            ...
            this.instancecontract = utils.processInterface(this.instanceMembers).toContract();
            this.classcontract = utils.processInterface(this.staticMembers);
            this.classcontract.setOpts({"class": this.instancecontract});
    ...
    var ModuleContract = (function () {
        ...
        ModuleContract.prototype.toContract = function() {
            ...
            for (i = 0; i < this.classes.length; i ++) {
                ...
                result = result + defineVariable(defined_instancename, this.classes[i].instancecontract);
