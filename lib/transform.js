...
var compile = function(source, callback) {
    ...
    if (result.code !== 0) {
        throw new Error('[No valid typescript supplied]: ' + result.stderr);
    }
    ...
    var ClassContract = (function () {
        var ClassContract = function(name, instanceMembers, staticMembers, _super, implementing, constructor) {
            ...
            if (typeof this.superclass !== "undefined") {
                this.instancecontract.extend(this.superclass);
            }
    ...
    var ModuleContract = (function () {
        ...
        ModuleContract.prototype.toContract = function() {
            ...
            if (this.external) {
                ...
                defined_classname = registerVariable(this.moduleName);
                result = result + defineVariable(defined_classname, this.moduleContract.toContract());
            }
            return result;
        };
