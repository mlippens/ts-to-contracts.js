    ...
    return falafel(src, function (node) {
        ...
        if (node.type === "VariableDeclaration") {
            ...
            if (node.declarations.length === 1) {
                ...
                if (typeDeclaration.type === "TypeDeclaration") {
                    type = Utils.convertToDefault(typeDeclaration.name);
                    declaration.update(identifier + " = " + Utils.guard(type, declaration.init.source()));
                } else if (typeDeclaration.type === "FunctionTypeDeclaration") {
