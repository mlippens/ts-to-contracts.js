...
utils = (function (utils) {
	...
	var object = function (object) {
        ...
        if (callType && newType) {
            obj = and(obj, fun_new_call(newType, callType));
        } else if (newType) {
    ...
    /**
     * this needs to be refactored in order to support separate new/call handlers!
...
exports.toContracts = function(src, module) {
	...
	return falafel(src, function (node) {
		...
		if (node.type === "AmbientFunctionDeclaration") {
			...
			identifier = node.id.name;
			declaration = node.declaration;
			type = utils.higherorderParams(declaration).toContract();
